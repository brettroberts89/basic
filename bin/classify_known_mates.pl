#TITLE: classify_known_mates.pl
#AUTHOR: BRETT ROBERTS
#DATE LAST MODIFIED: 08/16/2012
#PURPOSE: takes in two files: a .fa file of the Sato Assembly and a file with known mate pairs. Determines the possible lengths of the insert,
...
my $sato = "Sato.fa";
my $reads = "alnmateRun001_unmapped_F.csv";
my $output = "alnmateRun001_unmapped_F_classified.csv";
my $test = "known_contig_lengths.txt";
my $contig;
my %contig_lengths;
my %pairs;
open(OUT, ">$output");
