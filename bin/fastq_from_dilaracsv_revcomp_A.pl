#TITLE: fastq_from_dilaracsv_revcomp_A.pl
#AUTHOR: BRETT ROBERTS
#DATE LAST MODIFIED: 11/05/2012
#PURPOSE: takes in csv file with list of read pairs, and extracts the fastq entries for these and reverse complements them
